...
Test coverage is **unit-only — there is no end-to-end harness**, but it is no longer thin: **744 vitest + cargo (160 on macOS, 156 on Windows — the platform tests are `cfg`-gated)**, both run in CI on both OSes.
