...
Test coverage is **unit-only — there is no end-to-end harness**, but it is no longer thin: **695 vitest + cargo (156 on macOS, 153 on Windows — the platform tests are `cfg`-gated)**, both run in CI on both OSes.
