// GENERATED by scripts/gen-emoji.mjs from Unicode emoji-test.txt 17.0. Do not edit.
// One entry per emoji, "<char> <name>", ordered by group; EMOJI_GROUPS says where each starts.
export const EMOJI_GROUPS: readonly (readonly [string, number])[] = [["Smileys & Emotion",0],["People & Body",171],["Animals & Nature",559],["Food & Drink",719],["Travel & Places",850],["Activities",1069],["Objects",1154],["Symbols",1420],["Flags",1644]];

export const EMOJI_ALL: readonly string[] = [
  "😀 grinning face",
