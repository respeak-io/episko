...
// Turns Claude replays as `user` that nobody typed. Matched only at the start of a message:
// a `<system-reminder>` pasted INTO a real question leaves it a real question.
const ENVELOPES = [
  "<command-name>", "<command-message>", "<command-args>", "<local-command-stdout>",
  "<system-reminder>", "Caveat: The messages below were generated by the user",
