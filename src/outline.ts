...
// Turns nobody typed: what Claude replays as `user` in a transcript, and what it submits on
// its own — a background task reporting back arrives through `UserPromptSubmit` like a
// keystroke. Matched only at the start: a `<system-reminder>` pasted INTO a question leaves
// it a question.
const ENVELOPES = [
  "<command-name>", "<command-message>", "<command-args>", "<local-command-stdout>",
  "<system-reminder>", "<task-notification>", "Caveat: The messages below were generated by the user",
