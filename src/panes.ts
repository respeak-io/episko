...
// A pane's OSC title landed, for both agent spawners. `rawTitle` is kept even when the
// cleaned title is unchanged, so Settings can re-clean a pane that has since gone quiet.
