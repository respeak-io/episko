...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            git::list_protected_branches,
            git::set_protected_branch,
            git::switch_branch,
            git::git_commit_info,
            git::git_log_days,
            git::project_facts,
            ...
            platform::full_disk_access,
            platform::open_privacy_pane,
            platform::reset_app_data_prompts,
            platform::privacy_asks,
